...
export const vaultUI = loadUI(['header', 'headerLeftSide', 'title', 'welcomeTitle', 'savedOn', 'toggleSecureBtn', 'mainSection', 'headerRightSide', 'explorer', 'statusMsg'], 'vault_', 'vaultView');
